class Road extends Phaser.GameObjects.Container {
    ...
    constructor(config) {
        ...
        //this.background.diplayWidth = game.config.width * .5;
        // this.background.scaleY = this.background.scaleX;
        Align.scaleToGameW(this.background, .5)
        ...
        this.background.on('pointerdown', this.changeLanes, this)
        this.addObject()
    ...
    addObject() {
        ...
        {key:"barrier",speed:20, scale:8}, {key:"cone", speed:20, scale:5}]
    ...
    moveLines() {
        ...
        this.lineGroup.children.iterate(function (child) {
            child.y += this.vSpace / this.object.speed;
